...
Пакет реализует объектную модель доступа к сессии PHP.
...
[исходные коды]: https://github.com/Bashka/bricks_http_session/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_http_session/issues
